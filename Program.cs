...
internal class Program
{
    ...
    static Estudiante AgregarEstudiante()
    {
        ...
        while (string.IsNullOrWhiteSpace(estudiante.Nombre) || estudiante.Nombre.Length > 40)
        {
            Console.Clear();
        ...
        while (string.IsNullOrWhiteSpace(estudiante.Email) || estudiante.Email.Length > 40 || !IsValidEmail(estudiante.Email))
        {
            Console.Clear();
        ...
        while (string.IsNullOrWhiteSpace(estudiante.Direccion) || estudiante.Direccion.Length > 35)
        {
            Console.Clear();
            ...
            {   
                switch (opcion)
                {
                    case 1:
                        Console.Clear();
                        Console.WriteLine("1. Agregar Notas Quizzes.");
                        string codigoVerificado = VerificarEstudiante(listEstudiantes);
                        if (codigoVerificado != null)
                        {
                            Console.WriteLine($"Estudiante con código {codigoVerificado} verificado correctamente.");
                            Quizz quizz = AgregarQuizzes();
                            quizz.Codigo = codigoVerificado;
                            notasQuizz.Add(quizz);
                            Console.WriteLine("Notas de Quizz agregadas correctamente.");
                        }
                        else
                        {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        Console.WriteLine("Volviendo al menú principal. Presione una tecla para continuar.");
                        Console.ReadLine();
                        passive = false;
                        break;
                    default:
    ...
    static string VerificarEstudiante(List<Estudiante> estudiantes)
    {
    ...
    static void MostrarEstudiantes(List<Estudiante> estudiantes)
    {
        ...
        Console.WriteLine("{0,-15} {1,-35} {2,-35} {3,-35} {4, -5}", "Código", "Nombre", "Email", "Edad", "Dirección");
        foreach (Estudiante estudiante in estudiantes)
        {
